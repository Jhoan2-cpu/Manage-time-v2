export const messages = {
  es: {
    ...
    home: {
      heroEyebrow: 'Simple de usar, fácil de seguir',
      heroTitle: 'Haz seguimiento a tu trabajo de forma simple e intuitiva.',
      heroDescription:
        'Velor te ayuda a organizar tareas, registrar sesiones de enfoque y revisar tu jornada en un solo lugar. Todo está pensado para que avances con claridad, sin complicarte.',
      ...
      featureDualTimerTitle: 'Temporizador flexible',
      featureDualTimerSubtitle: 'Usa cronómetro o cuenta regresiva según tu ritmo',
      featureDailyLogTitle: 'Registro diario claro',
      featureDailyLogSubtitle: 'Visualiza tu jornada en bloques de tiempo fáciles de revisar',
      featureTaskQueueTitle: 'Tareas visuales',
      featureTaskQueueSubtitle: 'Organiza y retoma tareas con tarjetas por color',
      previewTaskTitle: 'Planificación de producto',
    ...
    auth: {
      login: {
        ...
        errors: {
          missingFields: 'Ingresa tu correo y contraseña.',
          invalidEmail: 'Ingresa un correo válido.',
        },
        heroEyebrow: 'Espacio de enfoque',
        heroTitle: 'Inicia sesión para retomar tu flujo.',
        heroDescription:
          'Continúa registrando sesiones de trabajo enfocadas, revisa tu registro diario y gestiona tareas dentro de tu espacio Velor.',
        metricSessionModeLabel: 'Modo de sesión',
        metricSessionModeValue: 'Temporizador + Cronómetro',
        metricDailyLogLabel: 'Tareas',
        metricDailyLogValue: 'Tarjetas personalizables',
        metricWorkspaceLabel: 'Registro diario',
        metricWorkspaceValue: 'Seguimiento claro por bloques',
        ...
        demoNotice: 'Demo habilitada. Cualquier correo y contraseña válidos abrirán el dashboard.',
      ...
      register: {
        ...
        heroDescription:
          'Configura tu espacio Velor para gestionar tareas, ejecutar sesiones de enfoque y mantener un registro diario limpio desde el primer día.',
        metricOnboardingLabel: 'Inicio',
        metricOnboardingValue: 'Configuración guiada',
        metricSignInLabel: 'Acceso',
        metricSignInValue: 'Correo o Google',
        metricWorkspaceLabel: 'Tareas',
        metricWorkspaceValue: 'Tarjetas personalizables',
        cardTitle: 'Registro',
        ...
        demoNotice: 'Registro demo habilitado. Esto crea solo una sesión.',
  ...
  en: {
    ...
    auth: {
      login: {
        ...
        metricDailyLogLabel: 'Tasks',
        metricDailyLogValue: 'Customizable cards',
        metricWorkspaceLabel: 'Daily Log',
        metricWorkspaceValue: 'Clear time blocks',
        cardTitle: 'Log In',
      ...
      register: {
        ...
        metricOnboardingValue: 'Guided setup',
        metricSignInLabel: 'Access',
        metricSignInValue: 'Email or Google',
        metricWorkspaceLabel: 'Tasks',
        metricWorkspaceValue: 'Customizable cards',
        cardTitle: 'Register',
        ...
        demoNotice: 'Demo register enabled. This creates a session only.',
