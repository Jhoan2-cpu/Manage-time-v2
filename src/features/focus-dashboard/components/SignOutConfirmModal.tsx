  ...
  return (
    ...
    >
      <div
        ...
        aria-modal="true"
        className="modal-card-animate w-[min(92vw,430px)] rounded-2xl border border-amber-500/20 bg-[#0a1429]/95 shadow-[0_28px_90px_rgba(1,8,22,0.78)]"
        onClick={(event) => event.stopPropagation()}
        role="dialog"
      >
        <header className="flex items-center justify-between border-b border-slate-800/80 px-5 py-4">
          <div className="flex items-center gap-3">
            <span className="grid h-9 w-9 place-items-center rounded-xl border border-amber-400/25 bg-amber-500/10 text-amber-200">
